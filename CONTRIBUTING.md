# Contributing to UI Action

> **Read-only mirror.** This repository (`symfinity/ui-action`) is published from the Symfinity product monorepo (`packages/ui-action/`). **Do not expect pull requests to be merged here.**

## Report bugs or request features

Open an [issue](https://github.com/symfinity/ui-action/issues) on this repository.
...
Open a pull request on the **product monorepo** (`packages/ui-action/`) on a `feature/{spec-id}-{slug}` branch. Do not rely on merging on this mirror.
